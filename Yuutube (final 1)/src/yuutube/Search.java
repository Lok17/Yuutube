...
//                Class.forName("com.mysql.jdbc.Driver");
                ...
                //search video
                String sql_video = "select video_id,video_name,user_id,view_count,like_count,dislike_count from videos where video_name = ? order by videos.view_count desc";
                //compile sql
                ...
                count = 0;
                String sql_keyword = "select video_id,video_name,user_id,view_count,like_count,dislike_count from videos where video_name regexp ? order by videos.view_count desc";
                //compile sql_keyword
...
//                Class.forName("com.mysql.jdbc.Driver");
    ...
    public static void directSearch(String searchContent) {
