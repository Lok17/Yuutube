...
public class MySQL {
	private static final String url = "jdbc:mysql://127.0.0.1:3306/utest?useSSL=false"; // MySQL username
...
//				System.out.println("connection successful!");
			...
			ResultSet rs = statement.executeQuery("SELECT user_id, user_name FROM users WHERE email='" + email + "';");
			if (rs.next()) {
